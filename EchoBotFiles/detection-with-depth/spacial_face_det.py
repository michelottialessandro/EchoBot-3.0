...
#stereo.setDepthAlign(camera=dai.CameraBoardSocket.RGB)
...
def display_info(frame, disp_frame, bbox, coordinates, status, status_color, fps):
    ...
    if coordinates is not None:
        ...
        cv2.putText(disp_frame, f'Depth: {math.trunc(coord_z)/1000}m', (15, 35), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255))
